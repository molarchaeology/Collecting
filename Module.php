...
class Module extends AbstractModule
{
    ...
    public function install(ServiceLocatorInterface $services)
    {
        ...
        $conn->exec("CREATE TABLE collecting_prompt (id INT AUTO_INCREMENT NOT NULL, form_id INT NOT NULL, property_id INT DEFAULT NULL, position INT NOT NULL, type VARCHAR(255) NOT NULL, text LONGTEXT DEFAULT NULL, input_type VARCHAR(255) DEFAULT NULL, input_options LONGTEXT DEFAULT NULL COMMENT '(DC2Type:json)', select_options LONGTEXT DEFAULT NULL, resource_query LONGTEXT DEFAULT NULL, custom_vocab INT DEFAULT NULL, media_type VARCHAR(255) DEFAULT NULL, required TINYINT(1) NOT NULL, multiple TINYINT(1) NOT NULL, INDEX IDX_98FE9BA65FF69B7D (form_id), INDEX IDX_98FE9BA6549213EC (property_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB;");
    ...
    public function upgrade($oldVersion, $newVersion, ServiceLocatorInterface $services)
    {
        ...
        if (Comparator::lessThan($oldVersion, '1.12.99')) {
            $conn->exec('ALTER TABLE collecting_prompt ADD multiple TINYINT(1) NOT NULL DEFAULT 0');
        }
        if (Comparator::lessThan($oldVersion, '1.12.999')) {
            $conn->exec("ALTER TABLE collecting_prompt ADD input_options LONGTEXT DEFAULT NULL COMMENT '(DC2Type:json)' AFTER input_type");
        }
    }
